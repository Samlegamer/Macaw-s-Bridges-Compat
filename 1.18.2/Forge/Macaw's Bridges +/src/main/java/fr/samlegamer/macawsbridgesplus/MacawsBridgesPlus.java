...
import fr.samlegamer.macawsbridgesplus.utils.Vanilla;

@Mod(MacawsBridgesPlus.MODID)
@Mod.EventBusSubscriber(modid = MacawsBridgesPlus.MODID, bus=Mod.EventBusSubscriber.Bus.MOD)
public class MacawsBridgesPlus
{
    ...
    public MacawsBridgesPlus()
    {
        ...
        MBPItemsRegistry.ITEMS_REGISTRY.register(bus);
