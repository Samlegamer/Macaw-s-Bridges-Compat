...
public class AbnormalsFixCompat
{
	...
	{		
		...
		addMissingBlock(event, BEES, "honeycomb_brick_bridge", MBABlocksRegistry.honeycomb_brick_bridge.get());
		addMissingBlock(event, BEES, "honeycomb_tile_bridge", MBABlocksRegistry.honeycomb_tile_bridge.get());
	...
	{		
		...
		addMissingItem(event, BEES, "honeycomb_brick_bridge", MBABlocksRegistry.honeycomb_brick_bridge.get().asItem());
		addMissingItem(event, BEES, "honeycomb_tile_bridge", MBABlocksRegistry.honeycomb_tile_bridge.get().asItem());
