...
public class MBBYGBlocksRegistry
{
	...
	public static final Block rope_mangrove_bridge = new Bridge_Block_Rope(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	public static final Block mangrove_bridge_pier = new Bridge_Support(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	public static final Block mangrove_log_bridge_stair = new Bridge_Stairs(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	public static final Block mangrove_rope_bridge_stair = new Bridge_Stairs(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
