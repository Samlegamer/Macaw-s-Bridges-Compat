...
public class MBBYGBlocksRegistry
{
	...
	public static final Block mangrove_log_bridge_middle = new Log_Bridge(WOOD);
	public static final Block rope_mangrove_bridge = new Bridge_Block_Rope(WOOD);
	public static final Block mangrove_bridge_pier = new Bridge_Support(WOOD);
	public static final Block mangrove_log_bridge_stair = new Bridge_Stairs(WOOD);
	public static final Block mangrove_rope_bridge_stair = new Bridge_Stairs(WOOD);
	public static final Block mangrove_rail_bridge = new Rail_Bridge(RAILS);
    ...
    private static void blockItem(Block b, String name)
    {
        ...
        {
            Registry.register(Registry.ITEM, new Identifier("macawsbridgesbyg", name), new BlockItemWithInfo(b, new Item.Settings().group(MacawsBridgesBYG.TAB)));
        }
        else {
            Registry.register(Registry.ITEM, new Identifier("macawsbridgesbyg", name), new BlockItem(b, new Item.Settings().group(MacawsBridgesBYG.TAB)));
        }
    }
}