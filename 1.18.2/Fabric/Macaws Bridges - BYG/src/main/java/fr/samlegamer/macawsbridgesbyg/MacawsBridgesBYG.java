...
{
	public static final ItemGroup TAB = FabricItemGroupBuilder.build(new Identifier("bridgesbyg_tab"), () -> new ItemStack(MBBYGBlocksRegistry.aspen_log_bridge_middle));
