	...
	public void onInitialize()
	{
		...
		ItemGroupEvents.modifyEntriesEvent(TAB).register(content -> {
		 content.add(MBBYGBlocksRegistry.aspen_log_bridge_middle);
   		 ...
   		 content.add(MBBYGBlocksRegistry.cryptic_stone_bridge);

   		 content.add(MBBYGBlocksRegistry.cryptic_stone_bridge_pier);

   		 content.add(MBBYGBlocksRegistry.cryptic_stone_bridge_stair);

   		 content.add(MBBYGBlocksRegistry.dacite_bricks_bridge);

   		 content.add(MBBYGBlocksRegistry.dacite_bricks_bridge_pier);

   		 content.add(MBBYGBlocksRegistry.dacite_bricks_bridge_stair);

   		 content.add(MBBYGBlocksRegistry.polished_travertine_bridge);

   		 content.add(MBBYGBlocksRegistry.polished_travertine_bridge_pier);

   		 content.add(MBBYGBlocksRegistry.polished_travertine_bridge_stair);

   		 content.add(MBBYGBlocksRegistry.purpur_stone_bridge);

   		 content.add(MBBYGBlocksRegistry.purpur_stone_bridge_pier);

   		 content.add(MBBYGBlocksRegistry.purpur_stone_bridge_stair);

   		 content.add(MBBYGBlocksRegistry.red_rock_bricks_bridge);

   		 content.add(MBBYGBlocksRegistry.red_rock_bricks_bridge_pier);

   		 content.add(MBBYGBlocksRegistry.red_rock_bricks_bridge_stair);

   		 content.add(MBBYGBlocksRegistry.scoria_stone_bricks_bridge);

   		 content.add(MBBYGBlocksRegistry.scoria_stone_bricks_bridge_pier);

   		 content.add(MBBYGBlocksRegistry.scoria_stone_bricks_bridge_stair);

   		 content.add(MBBYGBlocksRegistry.soapstone_bricks_bridge);

   		 content.add(MBBYGBlocksRegistry.soapstone_bricks_bridge_pier);

   		 content.add(MBBYGBlocksRegistry.soapstone_bricks_bridge_stair);
   		 //Finish
    		//Finish
    	});
	}
