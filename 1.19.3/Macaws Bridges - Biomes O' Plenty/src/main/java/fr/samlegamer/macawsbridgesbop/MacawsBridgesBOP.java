...
public class MacawsBridgesBOP
{
    ...
    {
    	 if (event.getTab() == MacawsBridges.BridgeItemGroup)
    	 {
    		 event.accept(MBBOPBlocksRegistry.cherry_log_bridge_middle.get());

    		 event.accept(MBBOPBlocksRegistry.rope_cherry_bridge.get());

    		 event.accept(MBBOPBlocksRegistry.cherry_bridge_pier.get());

    		 event.accept(MBBOPBlocksRegistry.cherry_log_bridge_stair.get());

    		 event.accept(MBBOPBlocksRegistry.cherry_rope_bridge_stair.get());

    		 event.accept(MBBOPBlocksRegistry.cherry_rail_bridge.get());
