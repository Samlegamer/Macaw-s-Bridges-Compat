...
public class RecipesGeneratorMacawsBridges
{
	...
	{
		public static void recipeGen(String location, String modidCompat, String material)
		{
			File file = new File(location + "/data/recipes/" + material + "_rope_bridge_stair" + ".json");
			...
			if(!file.exists())
			{
				try
				{
					...
					buffer.write("{\r\n"
							...
							+ "    \"result\":\r\n"
							+ "    {\r\n"
							+ "        \"item\":  \""+modidCompat+":"+material+"_rope_bridge_stair\",\r\n"
							+ "        \"count\": 6\r\n"
							+ "    }\r\n"
							+ "}");
		...
		public static void loot_tablesGen(String location, String modidCompat, String material)
		{
			File file = new File(location + "/data/loot_tables/" + material + "_rope_bridge_stair" + ".json");
			...
			if(!file.exists())
			{
				try
				{
					...
					buffer.write("{\r\n"
							...
							+ "				{\r\n"
							+ "					\"type\": \"minecraft:item\",\r\n"
							+ "					\"name\": \""+modidCompat+":"+material+"_rope_bridge_stair\"\r\n"
							+ "				}\r\n"
							+ "			]\r\n"
							+ "		}\r\n"
							+ "	]\r\n"
