...
public class MacawsBridgesCode
{
		...
		public static void BridgeLog(String Location, ArrayList<String> Material, String ClassMod)
		{
			...
			if(!file.exists())
			{
				try
				{
					...
					{
						buffer.write("RenderTypeLookup.setRenderLayer("+ClassMod+"."+i+"_log_bridge_middle.get(), RenderType.cutout());");
						buffer.newLine();
					}
		...
		public static void RopeBridge(String Location, ArrayList<String> Material, String ClassMod)
		{
			...
			if(!file.exists())
			{
				try
				{
					...
					for(String i : Material)
					{
						buffer.write("		RenderTypeLookup.setRenderLayer("+ClassMod+".rope_"+i+"_bridge.get(), RenderType.cutout());");
						buffer.newLine();
					}
		...
		public static void PierBridgeWood(String Location, ArrayList<String> Material, String ClassMod)
		{
			...
			if(!file.exists())
			{
				try
				{
					...
					for(String i : Material)
					{
						buffer.write("RenderTypeLookup.setRenderLayer("+ClassMod+"."+i+"_bridge_pier.get(), RenderType.cutout());");
						buffer.newLine();
					}
		...
		public static void BridgeStairsLog(String Location, ArrayList<String> Material, String ClassMod)
		{
			...
			if(!file.exists())
			{
				try
				{
					...
					for(String i : Material)
					{
						buffer.write("RenderTypeLookup.setRenderLayer("+ClassMod+"."+i+"_log_bridge_stair.get(), RenderType.cutout());");
						buffer.newLine();
					}
		...
		public static void BridgeRail(String Location, ArrayList<String> Material, String ClassMod)
		{
			...
			if(!file.exists())
			{
				try
				{
					...
					for(String i : Material)
					{
						buffer.write("RenderTypeLookup.setRenderLayer("+ClassMod+"."+i+"_rail_bridge.get(), RenderType.cutout());");
						buffer.newLine();
					}
		...
		public static void BridgeLog(String Location, ArrayList<String> Material)
		{
			...
			if(!file.exists())
			{
				try
				{
					...
					for(String i : Material)
					{
						buffer.write("public static final RegistryObject<Block> "+i+"_log_bridge_middle = createBlock(\""+i+"_log_bridge_middle\", () -> new Log_Bridge(AbstractBlock.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));");
						buffer.newLine();
					}
		...
		public static void RopeBridge(String Location, ArrayList<String> Material)
		{
			...
			if(!file.exists())
			{
				try
				{
					...
					for(String i : Material)
					{
						buffer.write("public static final RegistryObject<Block> rope_"+i+"_bridge = createBlock(\"rope_"+i+"_bridge\", () -> new Rope_Bridge(AbstractBlock.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));");
						buffer.newLine();
					}
		...
		public static void PierBridgeWood(String Location, ArrayList<String> Material)
		{
			...
			if(!file.exists())
			{
				try
				{
					...
					for(String i : Material)
					{
						buffer.write("public static final RegistryObject<Block> "+i+"_bridge_pier = createBlock(\""+i+"_bridge_pier\", () -> new Support_Pillar(AbstractBlock.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));");
						buffer.newLine();
					}
		...
		public static void BridgeStairsLog(String Location, ArrayList<String> Material)
		{
			...
			if(!file.exists())
			{
				try
				{
					...
					for(String i : Material)
					{
						buffer.write("public static final RegistryObject<Block> "+i+"_log_bridge_stair = createBlock(\""+i+"_log_bridge_stair\", () -> new Iron_Stair(AbstractBlock.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));");
						buffer.newLine();
					}
		...
		public static void BridgeRail(String Location, ArrayList<String> Material)
		{
			...
			if(!file.exists())
			{
				try
				{
					...
					for(String i : Material)
					{
						buffer.write("public static final RegistryObject<Block> "+i+"_rail_bridge = createBlock(\""+i+"_rail_bridge\", () -> new Rail_Bridge(AbstractBlock.Properties.of(Material.WOOD).noOcclusion().strength(0.5F, 2.5F).sound(SoundType.WOOD)));");
						buffer.newLine();
					}
