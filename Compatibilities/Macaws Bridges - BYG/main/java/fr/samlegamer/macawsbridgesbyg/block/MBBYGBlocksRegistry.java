...
public class MBBYGBlocksRegistry
{
    ...
    //Bridge Stone
    public static final RegistryObject<Block> cryptic_stone_bridge = createBlock("cryptic_stone_bridge", () -> new Log_Bridge(BlockBehaviour.Properties.of(Material.STONE).strength(3.0F, 5.0F).sound(SoundType.STONE)));
    public static final RegistryObject<Block> dacite_bricks_bridge = createBlock("dacite_bricks_bridge", () -> new Log_Bridge(BlockBehaviour.Properties.of(Material.STONE).strength(3.0F, 5.0F).sound(SoundType.STONE)));
    public static final RegistryObject<Block> polished_travertine_bridge = createBlock("polished_travertine_bridge", () -> new Log_Bridge(BlockBehaviour.Properties.of(Material.STONE).strength(3.0F, 5.0F).sound(SoundType.STONE)));
    public static final RegistryObject<Block> purpur_stone_bridge = createBlock("purpur_stone_bridge", () -> new Log_Bridge(BlockBehaviour.Properties.of(Material.STONE).strength(3.0F, 5.0F).sound(SoundType.STONE)));
    public static final RegistryObject<Block> red_rock_bricks_bridge = createBlock("red_rock_bricks_bridge", () -> new Log_Bridge(BlockBehaviour.Properties.of(Material.STONE).strength(3.0F, 5.0F).sound(SoundType.STONE)));
    public static final RegistryObject<Block> scoria_stone_bricks_bridge = createBlock("scoria_stone_bricks_bridge", () -> new Log_Bridge(BlockBehaviour.Properties.of(Material.STONE).strength(3.0F, 5.0F).sound(SoundType.STONE)));
    public static final RegistryObject<Block> soapstone_bricks_bridge = createBlock("soapstone_bricks_bridge", () -> new Log_Bridge(BlockBehaviour.Properties.of(Material.STONE).strength(3.0F, 5.0F).sound(SoundType.STONE)));
    ...
    public static final RegistryObject<Block> rope_mangrove_bridge = createBlock("rope_mangrove_bridge", () -> new Rope_Bridge(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> mangrove_bridge_pier = createBlock("mangrove_bridge_pier", () -> new Support_Pillar(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));
    ...
    //Bridge Pier Stone
    public static final RegistryObject<Block> cryptic_stone_bridge_pier = createBlock("cryptic_stone_bridge_pier", () -> new Support_Pillar(BlockBehaviour.Properties.of(Material.STONE).strength(3.0F, 5.0F).sound(SoundType.STONE)));
    public static final RegistryObject<Block> dacite_bricks_bridge_pier = createBlock("dacite_bricks_bridge_pier", () -> new Support_Pillar(BlockBehaviour.Properties.of(Material.STONE).strength(3.0F, 5.0F).sound(SoundType.STONE)));
    public static final RegistryObject<Block> polished_travertine_bridge_pier = createBlock("polished_travertine_bridge_pier", () -> new Support_Pillar(BlockBehaviour.Properties.of(Material.STONE).strength(3.0F, 5.0F).sound(SoundType.STONE)));
    public static final RegistryObject<Block> purpur_stone_bridge_pier = createBlock("purpur_stone_bridge_pier", () -> new Support_Pillar(BlockBehaviour.Properties.of(Material.STONE).strength(3.0F, 5.0F).sound(SoundType.STONE)));
    public static final RegistryObject<Block> red_rock_bricks_bridge_pier = createBlock("red_rock_bricks_bridge_pier", () -> new Support_Pillar(BlockBehaviour.Properties.of(Material.STONE).strength(3.0F, 5.0F).sound(SoundType.STONE)));
    public static final RegistryObject<Block> scoria_stone_bricks_bridge_pier = createBlock("scoria_stone_bricks_bridge_pier", () -> new Support_Pillar(BlockBehaviour.Properties.of(Material.STONE).strength(3.0F, 5.0F).sound(SoundType.STONE)));
    public static final RegistryObject<Block> soapstone_bricks_bridge_pier = createBlock("soapstone_bricks_bridge_pier", () -> new Support_Pillar(BlockBehaviour.Properties.of(Material.STONE).strength(3.0F, 5.0F).sound(SoundType.STONE)));

    /*
    public static final RegistryObject<Block> black_sandstone_bridge_pier = createBlock("black_sandstone_bridge_pier", () -> new Support_Pillar(BlockBehaviour.Properties.of(Material.STONE).strength(3.0F, 5.0F).sound(SoundType.STONE)));
    public static final RegistryObject<Block> blue_sandstone_bridge_pier = createBlock("blue_sandstone_bridge_pier", () -> new Support_Pillar(BlockBehaviour.Properties.of(Material.STONE).strength(3.0F, 5.0F).sound(SoundType.STONE)));
    public static final RegistryObject<Block> purple_sandstone_bridge_pier = createBlock("purple_sandstone_bridge_pier", () -> new Support_Pillar(BlockBehaviour.Properties.of(Material.STONE).strength(3.0F, 5.0F).sound(SoundType.STONE)));
    public static final RegistryObject<Block> white_sandstone_bridge_pier = createBlock("white_sandstone_bridge_pier", () -> new Support_Pillar(BlockBehaviour.Properties.of(Material.STONE).strength(3.0F, 5.0F).sound(SoundType.STONE)));
    */
    ...
    public static final RegistryObject<Block> mangrove_log_bridge_stair = createBlock("mangrove_log_bridge_stair", () -> new Iron_Stair(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));
    ...
    //Bridge Stair Stone
    public static final RegistryObject<Block> cryptic_stone_bridge_stair = createBlock("cryptic_stone_bridge_stair", () -> new Iron_Stair(BlockBehaviour.Properties.of(Material.STONE).strength(3.0F, 5.0F).sound(SoundType.STONE)));
    public static final RegistryObject<Block> dacite_bricks_bridge_stair = createBlock("dacite_bricks_bridge_stair", () -> new Iron_Stair(BlockBehaviour.Properties.of(Material.STONE).strength(3.0F, 5.0F).sound(SoundType.STONE)));
    public static final RegistryObject<Block> polished_travertine_bridge_stair = createBlock("polished_travertine_bridge_stair", () -> new Iron_Stair(BlockBehaviour.Properties.of(Material.STONE).strength(3.0F, 5.0F).sound(SoundType.STONE)));
    public static final RegistryObject<Block> purpur_stone_bridge_stair = createBlock("purpur_stone_bridge_stair", () -> new Iron_Stair(BlockBehaviour.Properties.of(Material.STONE).strength(3.0F, 5.0F).sound(SoundType.STONE)));
    public static final RegistryObject<Block> red_rock_bricks_bridge_stair = createBlock("red_rock_bricks_bridge_stair", () -> new Iron_Stair(BlockBehaviour.Properties.of(Material.STONE).strength(3.0F, 5.0F).sound(SoundType.STONE)));
    public static final RegistryObject<Block> scoria_stone_bricks_bridge_stair = createBlock("scoria_stone_bricks_bridge_stair", () -> new Iron_Stair(BlockBehaviour.Properties.of(Material.STONE).strength(3.0F, 5.0F).sound(SoundType.STONE)));
    public static final RegistryObject<Block> soapstone_bricks_bridge_stair = createBlock("soapstone_bricks_bridge_stair", () -> new Iron_Stair(BlockBehaviour.Properties.of(Material.STONE).strength(3.0F, 5.0F).sound(SoundType.STONE)));
    
    //Rails Wood
    public static final RegistryObject<Block> aspen_rail_bridge = createBlock("aspen_rail_bridge", () -> new Rail_Bridge(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> baobab_rail_bridge = createBlock("baobab_rail_bridge", () -> new Rail_Bridge(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> blue_enchanted_rail_bridge = createBlock("blue_enchanted_rail_bridge", () -> new Rail_Bridge(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> cika_rail_bridge = createBlock("cika_rail_bridge", () -> new Rail_Bridge(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> cypress_rail_bridge = createBlock("cypress_rail_bridge", () -> new Rail_Bridge(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> ebony_rail_bridge = createBlock("ebony_rail_bridge", () -> new Rail_Bridge(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> ether_rail_bridge = createBlock("ether_rail_bridge", () -> new Rail_Bridge(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> fir_rail_bridge = createBlock("fir_rail_bridge", () -> new Rail_Bridge(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> green_enchanted_rail_bridge = createBlock("green_enchanted_rail_bridge", () -> new Rail_Bridge(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> holly_rail_bridge = createBlock("holly_rail_bridge", () -> new Rail_Bridge(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> jacaranda_rail_bridge = createBlock("jacaranda_rail_bridge", () -> new Rail_Bridge(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> lament_rail_bridge = createBlock("lament_rail_bridge", () -> new Rail_Bridge(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> mahogany_rail_bridge = createBlock("mahogany_rail_bridge", () -> new Rail_Bridge(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> mangrove_rail_bridge = createBlock("mangrove_rail_bridge", () -> new Rail_Bridge(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> maple_rail_bridge = createBlock("maple_rail_bridge", () -> new Rail_Bridge(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> nightshade_rail_bridge = createBlock("nightshade_rail_bridge", () -> new Rail_Bridge(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> palm_rail_bridge = createBlock("palm_rail_bridge", () -> new Rail_Bridge(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> pine_rail_bridge = createBlock("pine_rail_bridge", () -> new Rail_Bridge(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> rainbow_eucalyptus_rail_bridge = createBlock("rainbow_eucalyptus_rail_bridge", () -> new Rail_Bridge(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> skyris_rail_bridge = createBlock("skyris_rail_bridge", () -> new Rail_Bridge(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> willow_rail_bridge = createBlock("willow_rail_bridge", () -> new Rail_Bridge(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> witch_hazel_rail_bridge = createBlock("witch_hazel_rail_bridge", () -> new Rail_Bridge(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> zelkova_rail_bridge = createBlock("zelkova_rail_bridge", () -> new Rail_Bridge(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> redwood_rail_bridge = createBlock("redwood_rail_bridge", () -> new Rail_Bridge(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));
    public static final RegistryObject<Block> cherry_rail_bridge = createBlock("cherry_rail_bridge", () -> new Rail_Bridge(BlockBehaviour.Properties.of(Material.WOOD).strength(0.5F, 2.5F).sound(SoundType.WOOD)));
