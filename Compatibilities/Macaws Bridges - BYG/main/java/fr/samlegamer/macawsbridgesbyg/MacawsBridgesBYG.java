...
public class MacawsBridgesBYG
{
	...
	private void ClientSetup(FMLClientSetupEvent event)
	{
		...
		ItemBlockRenderTypes.setRenderLayer(MBBYGBlocksRegistry.mangrove_log_bridge_middle.get(), RenderType.cutout());
		...
		/*
		ItemBlockRenderTypes.setRenderLayer(MBBYGBlocksRegistry.black_sandstone_bridge_middle.get(), RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MBBYGBlocksRegistry.blue_sandstone_bridge_middle.get(), RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MBBYGBlocksRegistry.purple_sandstone_bridge_middle.get(), RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MBBYGBlocksRegistry.white_sandstone_bridge_middle.get(), RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MBBYGBlocksRegistry.black_sandstone_bridge_stair.get(), RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MBBYGBlocksRegistry.blue_sandstone_bridge_stair.get(), RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MBBYGBlocksRegistry.purple_sandstone_bridge_stair.get(), RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MBBYGBlocksRegistry.white_sandstone_bridge_stair.get(), RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MBBYGBlocksRegistry.black_sandstone_bridge_pier.get(), RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MBBYGBlocksRegistry.blue_sandstone_bridge_pier.get(), RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MBBYGBlocksRegistry.purple_sandstone_bridge_pier.get(), RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(MBBYGBlocksRegistry.white_sandstone_bridge_pier.get(), RenderType.cutout());
		*/
		...
		ItemBlockRenderTypes.setRenderLayer(MBBYGBlocksRegistry.rope_mangrove_bridge.get(), RenderType.cutout());
		...
		ItemBlockRenderTypes.setRenderLayer(MBBYGBlocksRegistry.mangrove_bridge_pier.get(), RenderType.cutout());
		...
		ItemBlockRenderTypes.setRenderLayer(MBBYGBlocksRegistry.mangrove_log_bridge_stair.get(), RenderType.cutout());
		...
		ItemBlockRenderTypes.setRenderLayer(MBBYGBlocksRegistry.mangrove_rail_bridge.get(), RenderType.cutout());
