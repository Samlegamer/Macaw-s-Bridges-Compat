...
public class MBABlocksRegistry
{
	...
	public static final RegistryObject<Block> cypress_log_bridge_stair = createBlock("bayou_blues", "cypress_log_bridge_stair", () -> new Iron_Stair(AbstractBlock.Properties.of(Material.WOOD).noOcclusion().strength(0.5F, 2.5F).harvestTool(ToolType.AXE).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> cypress_bridge_pier = createBlock("bayou_blues", "cypress_bridge_pier", () -> new Support_Pillar(AbstractBlock.Properties.of(Material.WOOD).noOcclusion().strength(0.5F, 2.5F).harvestTool(ToolType.AXE).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> rope_cypress_bridge = createBlock("bayou_blues", "rope_cypress_bridge", () -> new Rope_Bridge(AbstractBlock.Properties.of(Material.WOOD).noOcclusion().strength(0.5F, 2.5F).harvestTool(ToolType.AXE).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<Block> rope_brown_mushroom_bridge = createBlock("enhanced_mushrooms", "rope_brown_mushroom_bridge", () -> new Rope_Bridge(AbstractBlock.Properties.of(Material.WOOD).strength(0.5F, 2.5F).harvestTool(ToolType.AXE).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> rope_red_mushroom_bridge = createBlock("enhanced_mushrooms", "rope_red_mushroom_bridge", () -> new Rope_Bridge(AbstractBlock.Properties.of(Material.WOOD).strength(0.5F, 2.5F).harvestTool(ToolType.AXE).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> brown_mushroom_bridge_pier = createBlock("enhanced_mushrooms", "brown_mushroom_bridge_pier", () -> new Support_Pillar(AbstractBlock.Properties.of(Material.WOOD).strength(0.5F, 2.5F).harvestTool(ToolType.AXE).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> red_mushroom_bridge_pier = createBlock("enhanced_mushrooms", "red_mushroom_bridge_pier", () -> new Support_Pillar(AbstractBlock.Properties.of(Material.WOOD).strength(0.5F, 2.5F).harvestTool(ToolType.AXE).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> brown_mushroom_log_bridge_stair = createBlock("enhanced_mushrooms", "brown_mushroom_log_bridge_stair", () -> new Iron_Stair(AbstractBlock.Properties.of(Material.WOOD).strength(0.5F, 2.5F).harvestTool(ToolType.AXE).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> red_mushroom_log_bridge_stair = createBlock("enhanced_mushrooms", "red_mushroom_log_bridge_stair", () -> new Iron_Stair(AbstractBlock.Properties.of(Material.WOOD).strength(0.5F, 2.5F).harvestTool(ToolType.AXE).sound(SoundType.WOOD)));
