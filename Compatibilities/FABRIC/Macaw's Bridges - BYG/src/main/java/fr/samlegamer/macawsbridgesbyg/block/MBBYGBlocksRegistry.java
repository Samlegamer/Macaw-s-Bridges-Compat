...
public class MBBYGBlocksRegistry
{
    ...
    public static final Block cryptic_stone_bridge_pier = new Support_Pillar(STONE_BRIDGES);
    public static final Block cryptic_stone_bridge_stair = new Iron_Stair(STONE_BRIDGES);
    public static final Block dacite_bricks_bridge = new Log_Bridge(STONE_BRIDGES);
    public static final Block dacite_bricks_bridge_pier = new Support_Pillar(STONE_BRIDGES);
    public static final Block dacite_bricks_bridge_stair = new Iron_Stair(STONE_BRIDGES);
    public static final Block polished_travertine_bridge = new Log_Bridge(STONE_BRIDGES);
    public static final Block polished_travertine_bridge_pier = new Support_Pillar(STONE_BRIDGES);
    public static final Block polished_travertine_bridge_stair = new Iron_Stair(STONE_BRIDGES);
    public static final Block purpur_stone_bridge = new Log_Bridge(STONE_BRIDGES);
    public static final Block purpur_stone_bridge_pier = new Support_Pillar(STONE_BRIDGES);
    public static final Block purpur_stone_bridge_stair = new Iron_Stair(STONE_BRIDGES);
    public static final Block red_rock_bricks_bridge = new Log_Bridge(STONE_BRIDGES);
    public static final Block red_rock_bricks_bridge_pier = new Support_Pillar(STONE_BRIDGES);
    public static final Block red_rock_bricks_bridge_stair = new Iron_Stair(STONE_BRIDGES);
    public static final Block scoria_stone_bricks_bridge = new Log_Bridge(STONE_BRIDGES);
    public static final Block scoria_stone_bricks_bridge_pier = new Support_Pillar(STONE_BRIDGES);
    public static final Block scoria_stone_bricks_bridge_stair = new Iron_Stair(STONE_BRIDGES);
    public static final Block soapstone_bricks_bridge = new Log_Bridge(STONE_BRIDGES);
    public static final Block soapstone_bricks_bridge_pier = new Support_Pillar(STONE_BRIDGES);
    public static final Block soapstone_bricks_bridge_stair = new Iron_Stair(STONE_BRIDGES);
	...
	public static final Block rope_aspen_bridge = new Rope_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	public static final Block aspen_bridge_pier = new Support_Pillar(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	public static final Block aspen_log_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	public static final Block aspen_rope_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	...
	public static final Block rope_baobab_bridge = new Rope_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block baobab_bridge_pier = new Support_Pillar(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block baobab_log_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block baobab_rope_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	...
	public static final Block rope_blue_enchanted_bridge = new Rope_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block blue_enchanted_bridge_pier = new Support_Pillar(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block blue_enchanted_log_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block blue_enchanted_rope_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	...
	public static final Block rope_cherry_bridge = new Rope_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block cherry_bridge_pier = new Support_Pillar(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block cherry_log_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block cherry_rope_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	...
	public static final Block rope_cika_bridge = new Rope_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block cika_bridge_pier = new Support_Pillar(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block cika_log_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block cika_rope_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	...
	public static final Block rope_cypress_bridge = new Rope_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block cypress_bridge_pier = new Support_Pillar(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block cypress_log_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block cypress_rope_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	...
	public static final Block rope_ebony_bridge = new Rope_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block ebony_bridge_pier = new Support_Pillar(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block ebony_log_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block ebony_rope_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	...
	public static final Block rope_ether_bridge = new Rope_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block ether_bridge_pier = new Support_Pillar(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block ether_log_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block ether_rope_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	...
	public static final Block rope_fir_bridge = new Rope_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block fir_bridge_pier = new Support_Pillar(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block fir_log_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block fir_rope_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	...
	public static final Block rope_green_enchanted_bridge = new Rope_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block green_enchanted_bridge_pier = new Support_Pillar(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block green_enchanted_log_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block green_enchanted_rope_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	...
	public static final Block rope_holly_bridge = new Rope_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block holly_bridge_pier = new Support_Pillar(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block holly_log_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block holly_rope_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	...
	public static final Block rope_jacaranda_bridge = new Rope_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block jacaranda_bridge_pier = new Support_Pillar(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block jacaranda_log_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block jacaranda_rope_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	...
	public static final Block rope_lament_bridge = new Rope_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block lament_bridge_pier = new Support_Pillar(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block lament_log_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block lament_rope_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	...
	public static final Block rope_mahogany_bridge = new Rope_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block mahogany_bridge_pier = new Support_Pillar(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block mahogany_log_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block mahogany_rope_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	...
	public static final Block mangrove_log_bridge_middle = new Log_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block rope_mangrove_bridge = new Rope_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block mangrove_bridge_pier = new Support_Pillar(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block mangrove_log_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block mangrove_rope_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block mangrove_rail_bridge = new Rail_Bridge(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	...
	public static final Block rope_maple_bridge = new Rope_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block maple_bridge_pier = new Support_Pillar(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block maple_log_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block maple_rope_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	...
	public static final Block rope_nightshade_bridge = new Rope_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block nightshade_bridge_pier = new Support_Pillar(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block nightshade_log_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block nightshade_rope_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	...
	public static final Block rope_palm_bridge = new Rope_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block palm_bridge_pier = new Support_Pillar(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block palm_log_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block palm_rope_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	...
	public static final Block rope_pine_bridge = new Rope_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block pine_bridge_pier = new Support_Pillar(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block pine_log_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block pine_rope_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	...
	public static final Block rope_rainbow_eucalyptus_bridge = new Rope_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block rainbow_eucalyptus_bridge_pier = new Support_Pillar(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block rainbow_eucalyptus_log_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block rainbow_eucalyptus_rope_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	...
	public static final Block rope_redwood_bridge = new Rope_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block redwood_bridge_pier = new Support_Pillar(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block redwood_log_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block redwood_rope_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	...
	public static final Block rope_skyris_bridge = new Rope_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block skyris_bridge_pier = new Support_Pillar(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block skyris_log_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block skyris_rope_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	...
	public static final Block rope_willow_bridge = new Rope_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block willow_bridge_pier = new Support_Pillar(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block willow_log_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block willow_rope_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	...
	public static final Block rope_witch_hazel_bridge = new Rope_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block witch_hazel_bridge_pier = new Support_Pillar(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block witch_hazel_log_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block witch_hazel_rope_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	...
	public static final Block rope_zelkova_bridge = new Rope_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block zelkova_bridge_pier = new Support_Pillar(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block zelkova_log_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block zelkova_rope_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	...
	public static final Block rope_bulbis_bridge = new Rope_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block bulbis_bridge_pier = new Support_Pillar(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block bulbis_log_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block bulbis_rope_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	...
	public static final Block rope_imparius_bridge = new Rope_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block imparius_bridge_pier = new Support_Pillar(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block imparius_log_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block imparius_rope_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
	...
	public static final Block rope_sythian_bridge = new Rope_Bridge(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block sythian_bridge_pier = new Support_Pillar(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block sythian_log_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));

	public static final Block sythian_rope_bridge_stair = new Iron_Stair(AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(0.5F, 2.5F).sounds(BlockSoundGroup.WOOD));
    ...
    {
    	Registry.register(Registry.BLOCK, new Identifier("macawsbridgesbyg", name), b);
    	blockItem(b, name);
	}
    
    private static void blockItem(Block b, String n)
    {
        Registry.register(Registry.ITEM, new Identifier("macawsbridgesbyg", n), new BlockItem(b, new Item.Settings().group(MacawsBridgesBYG.TAB)));
    }
}