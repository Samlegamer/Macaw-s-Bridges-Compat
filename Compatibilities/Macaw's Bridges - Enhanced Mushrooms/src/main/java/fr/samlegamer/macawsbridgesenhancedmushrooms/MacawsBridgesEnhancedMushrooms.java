...
public class MacawsBridgesEnhancedMushrooms
{
	...
	public static final Tab CMT = new Tab("mbenhancedmush_tab");
	...
	static class Tab extends ItemGroup
	{
		...
		@Override
		public ItemStack makeIcon() { return new ItemStack(MBEMBlockRegistry.red_mushroom_log_bridge_middle.get()); }
	}
}