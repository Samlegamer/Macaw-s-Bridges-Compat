...
public class McwBridgesShroomed
{
	...
	public static final Tab CMT = new Tab("mbs_tab");
	...
	static class Tab extends ItemGroup
	{
		...
		@Override
		public ItemStack makeIcon() { return new ItemStack(MBSBlocksRegistry.orange_hard_mushroom_log_bridge_middle.get()); }
	}
}