...
public class MacawsBridgesBYG
{
	...
	private void ClientSetup(FMLClientSetupEvent event)
	{
		...
		*/
		...
		//RenderTypeLookup.setRenderLayer(MBBYGBlocksRegistry.dacite_brick_bridge_middle.get(), RenderType.cutout());
		//RenderTypeLookup.setRenderLayer(MBBYGBlocksRegistry.red_rock_brick_bridge_middle.get(), RenderType.cutout());
