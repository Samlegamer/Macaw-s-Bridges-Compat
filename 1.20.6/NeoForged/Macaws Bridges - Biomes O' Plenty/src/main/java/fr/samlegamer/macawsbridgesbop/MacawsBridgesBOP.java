...
public class MacawsBridgesBOP
{
    ...
    public MacawsBridgesBOP(IEventBus bus)
    {
        ...
        MBBOPBlocksRegistry.Item_Group.register(bus);
	...
	private void ClientSetup(FMLClientSetupEvent event)
	{
		...
		ItemBlockRenderTypes.setRenderLayer(MBBOPBlocksRegistry.empyreal_log_bridge_middle.get(), RenderType.cutout());
		...
		ItemBlockRenderTypes.setRenderLayer(MBBOPBlocksRegistry.empyreal_bridge_pier.get(), RenderType.cutout());
		...
		ItemBlockRenderTypes.setRenderLayer(MBBOPBlocksRegistry.empyreal_rail_bridge.get(), RenderType.cutout());
		...
		ItemBlockRenderTypes.setRenderLayer(MBBOPBlocksRegistry.rope_empyreal_bridge.get(), RenderType.cutout());
		...
		ItemBlockRenderTypes.setRenderLayer(MBBOPBlocksRegistry.empyreal_rope_bridge_stair.get(), RenderType.cutout());
		...
		ItemBlockRenderTypes.setRenderLayer(MBBOPBlocksRegistry.empyreal_log_bridge_stair.get(), RenderType.cutout());
	}
    
    private void AddTab(BuildCreativeModeTabContentsEvent event)
    {
    	 if (event.getTab() == MBBOPBlocksRegistry.MB_CT.get())
    	 {
    		 ...
    		 event.accept(MBBOPBlocksRegistry.empyreal_log_bridge_middle.get());

    		 event.accept(MBBOPBlocksRegistry.rope_empyreal_bridge.get());

    		 event.accept(MBBOPBlocksRegistry.empyreal_bridge_pier.get());

    		 event.accept(MBBOPBlocksRegistry.empyreal_log_bridge_stair.get());

    		 event.accept(MBBOPBlocksRegistry.empyreal_rope_bridge_stair.get());

    		 event.accept(MBBOPBlocksRegistry.empyreal_rail_bridge.get());
    	 }
    }
}