...
public class MBBOPBlocksRegistry
{
    ...
    {
    	Registry.register(Registries.BLOCK, Identifier.of(MacawsBridgesBOP.MODID, name), b);
    	blockItem(b, name);
	}
    
    private static void blockItem(Block b, String n)
    {
        Registry.register(Registries.ITEM, Identifier.of(MacawsBridgesBOP.MODID, n), new BlockItem(b, new Item.Settings()));
    }
